...
@hydra_runner(config_path="/workspace/scripts/conf", config_name="finetune")
...
def main(cfg) -> None:
    ...
    with open_dict(cfg):
        ...
        # Remove unsupported args to avoid crash
        if 'num_workers' in cfg.model.data:
            cfg.model.data.pop("num_workers", None)
